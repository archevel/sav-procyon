...
export const STRINGS = {
  ...
  /* --------------- sharing ---------------------------------------------- */
  'share.button':    { sv: 'Dela',          en: 'Share' },
  'share.title':     { sv: 'Dela',          en: 'Share' },
  'share.cardTitle': { sv: 'Procyonsektorn',en: 'Procyon Sector' },
  'share.exportHint':{ sv: 'Välj vad som ska följa med. PNG:en visas som ett kort i chatten och kan importeras här.',
                       en: 'Pick what to send. The PNG previews as a card in chat and imports here.' },
  ...
  'share.size':      { sv: '%n valda · länk %b', en: '%n selected · link %b' },
  'share.png':       { sv: 'Ladda ner PNG', en: 'Download PNG' },
  'share.json':      { sv: 'Ladda ner JSON',en: 'Download JSON' },
  'share.link':      { sv: 'Kopiera länk',  en: 'Copy link' },
  'share.linkNoImages': { sv: 'Kopiera länk (utan bilder)',
                          en: 'Copy link (without images)' },
  'share.copied':    { sv: 'Länken är kopierad.', en: 'Link copied.' },
  'share.tooLongForLink': { sv: 'För mycket data för en länk — använd PNG eller JSON.',
                            en: 'Too much data for a link — use PNG or JSON.' },
  'share.imagesNote':{ sv: '%n bild(er) följer med i PNG och JSON, men inte i en länk.',
                       en: '%n image(s) travel in the PNG and JSON, but not in a link.' },
  ...
  'share.errBadLink':{ sv: 'Länken gick inte att läsa — den kan ha kapats på vägen.',
                       en: 'That link could not be read — it may have been truncated.' },
