...
export const STRINGS = {
  ...
  'sav.cerberus':                     { sv: 'Cerberus', en: 'Cerberus' },
  'sav.cold':                         { sv: 'Kall', en: 'Cold' },
  'sav.colonist':                     { sv: 'Kolonist', en: 'Colonist' },
  'sav.coreworlder':                  { sv: 'Kärnvärldsbo', en: 'Coreworlder' },
  'sav.faith':                        { sv: 'Tro', en: 'Faith' },
  'sav.firedrake':                    { sv: 'Firedrake', en: 'Firedrake' },
  'sav.gambling':                     { sv: 'Spel', en: 'Gambling' },
  'sav.haunted':                      { sv: 'Hemsökt', en: 'Haunted' },
  'sav.labor':                        { sv: 'Arbetare', en: 'Labor' },
  ...
  'sav.obligation':                   { sv: 'Plikt', en: 'Obligation' },
  'sav.obsessed':                     { sv: 'Besatt', en: 'Obsessed' },
  'sav.paranoid':                     { sv: 'Paranoid', en: 'Paranoid' },
  'sav.pilot':                        { sv: 'Styrman', en: 'Pilot' },
  'sav.pleasure':                     { sv: 'Njutning', en: 'Pleasure' },
  'sav.reckless':                     { sv: 'Vårdslös', en: 'Reckless' },
  'sav.rim-dweller':                  { sv: 'Utkantsbo', en: 'Rim Dweller' },
  'sav.scoundrel':                    { sv: 'Skurk', en: 'Scoundrel' },
  'sav.soft':                         { sv: 'Vek', en: 'Soft' },
  'sav.speaker':                      { sv: 'Ombudsman', en: 'Speaker' },
  'sav.stardancer':                   { sv: 'Stardancer', en: 'Stardancer' },
  'sav.stitch':                       { sv: 'Fältskär', en: 'Stitch' },
  'sav.stupor':                       { sv: 'Berusning', en: 'Stupor' },
  'sav.synthetic':                    { sv: 'Syntet', en: 'Synthetic' },
  'sav.trade':                        { sv: 'Handel', en: 'Trade' },
  'sav.underworld':                   { sv: 'Undre världen', en: 'Underworld' },
  'sav.unstable':                     { sv: 'Instabil', en: 'Unstable' },
  'sav.vicious':                      { sv: 'Grym', en: 'Vicious' },
  'sav.voidborn':                     { sv: 'Tomrumsfödd', en: 'Voidborn' },
  'sav.wanderer':                     { sv: 'Vandrare', en: 'Wanderer' },
  'sav.weird':                        { sv: 'Det underliga', en: 'Weird' },
  'sav.xeno':                         { sv: 'Xeno', en: 'Xeno' },

  /* ---- Starting abilities. One per playbook, never chosen. -------------- */
  'sav.unstoppable':            { sv: 'Ostoppbar', en: 'Unstoppable' },
  'sav.ace-pilot':              { sv: 'Flygaress', en: 'Ace Pilot' },
  'sav.air-of-respectability':  { sv: 'Respektabel uppsyn', en: 'Air of Respectability' },
  'sav.serendipitous':          { sv: 'Lyckosam', en: 'Serendipitous' },
  'sav.im-a-doctor-not-a':      { sv: 'Jag är läkare, inte…', en: 'I’m a Doctor, Not a…' },
  'sav.tinker':                 { sv: 'Mekare', en: 'Tinker' },
  'sav.the-way':                { sv: 'Vägen', en: 'The Way' },

  /* ---- Special abilities, by playbook, in the book's order. ------------- */
  /* Muscle */
  'sav.wrecking-crew':          { sv: 'Rivningsfirma', en: 'Wrecking Crew' },
  'sav.backup':                 { sv: 'Uppbackning', en: 'Backup' },
  'sav.battleborn':             { sv: 'Stridsfödd', en: 'Battleborn' },
  'sav.bodyguard':              { sv: 'Livvakt', en: 'Bodyguard' },
  'sav.flesh-wound':            { sv: 'Köttsår', en: 'Flesh Wound' },
  'sav.predator':               { sv: 'Rovdjur', en: 'Predator' },
  'sav.ready-for-anything':     { sv: 'Beredd på allt', en: 'Ready for Anything' },
  'sav.scary':                  { sv: 'Skrämmande', en: 'Scary' },
  /* Pilot */
  'sav.keen-eye':               { sv: 'Skarpt öga', en: 'Keen Eye' },
  'sav.side-job':               { sv: 'Extraknäck', en: 'Side Job' },
  'sav.exceed-specs':           { sv: 'Överskrid specifikationen', en: 'Exceed Specs' },
  'sav.leaf-on-the-wind':       { sv: 'Löv för vinden', en: 'Leaf on the Wind' },
  'sav.hedonist':               { sv: 'Hedonist', en: 'Hedonist' },
  'sav.commander':              { sv: 'Befälhavare', en: 'Commander' },
  'sav.traveler':               { sv: 'Världsvan', en: 'Traveler' },
  'sav.punch-it':               { sv: 'Ge järnet!', en: 'Punch It!' },
  /* Speaker */
  'sav.favors-owed':            { sv: 'Tjänster till godo', en: 'Favors Owed' },
  'sav.player':                 { sv: 'Spelare', en: 'Player' },
  'sav.infiltrator':            { sv: 'Infiltratör', en: 'Infiltrator' },
  'sav.subterfuge':             { sv: 'Undanflykt', en: 'Subterfuge' },
  'sav.heart-to-heart':         { sv: 'Hjärta till hjärta', en: 'Heart to Heart' },
  'sav.old-friends':            { sv: 'Gamla vänner', en: 'Old Friends' },
  'sav.disarming':              { sv: 'Avväpnande', en: 'Disarming' },
  'sav.purpose':                { sv: 'Mening', en: 'Purpose' },
  /* Scoundrel */
  'sav.never-tell-me-the-odds': { sv: 'Nämn aldrig oddsen', en: 'Never Tell Me the Odds' },
  'sav.i-know-a-guy':           { sv: 'Jag känner en kille', en: 'I Know a Guy' },
  'sav.tenacious':              { sv: 'Seg', en: 'Tenacious' },
  'sav.when-the-chips-are-down': { sv: 'När det gäller', en: 'When the Chips Are Down' },
  'sav.devils-own-luck':        { sv: 'Djävulens tur', en: 'Devil’s Own Luck' },
  'sav.daredevil':              { sv: 'Våghals', en: 'Daredevil' },
  'sav.shoot-first':            { sv: 'Skjut först', en: 'Shoot First' },
  'sav.ask-questions-later':    { sv: 'Fråga sen', en: 'Ask Questions Later' },
  /* Stitch */
  'sav.physicker':              { sv: 'Läkekonst', en: 'Physicker' },
  'sav.patch':                  { sv: 'Lappa ihop', en: 'Patch' },
  'sav.welcome-anywhere':       { sv: 'Välkommen överallt', en: 'Welcome Anywhere' },
  'sav.under-pressure':         { sv: 'Under press', en: 'Under Pressure' },
  'sav.combat-medic':           { sv: 'Stridssjukvårdare', en: 'Combat Medic' },
  'sav.moral-compass':          { sv: 'Moralisk kompass', en: 'Moral Compass' },
  'sav.dr-strange':             { sv: 'Dr Sällsam', en: 'Dr. Strange' },
  'sav.book-learning':          { sv: 'Boklärd', en: 'Book Learning' },
  /* Mechanic */
  'sav.bailing-wire-and-mech-tape': { sv: 'Ståltråd och mektejp', en: 'Bailing Wire and Mech-Tape' },
  'sav.construct-whisperer':    { sv: 'Maskinviskare', en: 'Construct Whisperer' },
  'sav.junkyard-hunter':        { sv: 'Skrotjägare', en: 'Junkyard Hunter' },
  'sav.hacker':                 { sv: 'Hackare', en: 'Hacker' },
  'sav.fixed':                  { sv: 'Fixad', en: 'Fixed' },
  'sav.mechanics-heart':        { sv: 'Mekanikerns hjärta', en: 'Mechanic’s Heart' },
  'sav.overclock':              { sv: 'Överklocka', en: 'Overclock' },
  'sav.analyst':                { sv: 'Analytiker', en: 'Analyst' },
  /* Mystic */
  'sav.kinetics':               { sv: 'Kinetik', en: 'Kinetics' },
  'sav.psy-blade':              { sv: 'Psyklinga', en: 'Psy-Blade' },
  'sav.center':                 { sv: 'Centrering', en: 'Center' },
  'sav.way-shield':             { sv: 'Vägsköld', en: 'Way Shield' },
  'sav.warded':                 { sv: 'Skyddad', en: 'Warded' },
  'sav.psy-dancing':            { sv: 'Psykodans', en: 'Psy-Dancing' },
  'sav.visions':                { sv: 'Visioner', en: 'Visions' },
  'sav.sundering':              { sv: 'Sönderslitning', en: 'Sundering' },
  /* Closes every playbook's list. */
  'sav.veteran':                { sv: 'Veteran', en: 'Veteran' },


  /* ---- Ship modules, by the system they belong to. ---------------------- */
  /* Hull */
  'sav.cargo-hold':             { sv: 'Lastrum', en: 'Cargo Hold' },
  'sav.crew-quarters':          { sv: 'Besättningshytter', en: 'Crew Quarters' },
  'sav.landing-bay':            { sv: 'Landningsdäck', en: 'Landing Bay' },
  'sav.smuggling-compartments': { sv: 'Smugglingsutrymmen', en: 'Smuggling Compartments' },
  /* Engines */
  'sav.afterburners':           { sv: 'Efterbrännare', en: 'Afterburners' },
  'sav.cloaking-device':        { sv: 'Döljarfält', en: 'Cloaking Device' },
  'sav.gravitic-field-generator': { sv: 'Gravitationsfältsgenerator', en: 'Gravitic Field Generator' },
  'sav.jump-drive':             { sv: 'Hoppmotor', en: 'Jump Drive' },
  /* Comms */
  'sav.fake-transponder':       { sv: 'Falsk transponder', en: 'Fake Transponder' },
  'sav.long-range-scanner':     { sv: 'Långdistansskanner', en: 'Long-Range Scanner' },
  'sav.nexus-link':             { sv: 'Nexuslänk', en: 'Nexus Link' },
  'sav.quantum-encryptor':      { sv: 'Kvantkrypterare', en: 'Quantum Encryptor' },
  'sav.targeting-computer':     { sv: 'Måldator', en: 'Targeting Computer' },
  /* Weapons */
  'sav.coherence-cannon':       { sv: 'Koherenskanon', en: 'Coherence Cannon' },
  'sav.grappling-hooks':        { sv: 'Änterhakar', en: 'Grappling Hooks' },
  'sav.mining-drill':           { sv: 'Gruvborr', en: 'Mining Drill' },
  'sav.missiles':               { sv: 'Missiler', en: 'Missiles' },
  'sav.particle-cannons':       { sv: 'Partikelkanoner', en: 'Particle Cannons' },

  /* ---- Auxiliary modules. Exempt from the per-system limit. ------------- */
  'sav.ai-module':              { sv: 'AI-modul', en: 'AI Module' },
  'sav.armory':                 { sv: 'Vapenförråd', en: 'Armory' },
  'sav.brig':                   { sv: 'Arrest', en: 'Brig' },
  'sav.galley':                 { sv: 'Kabyss', en: 'Galley' },
  'sav.medical-bay':            { sv: 'Sjukavdelning', en: 'Medical Bay' },
  'sav.science-bay':            { sv: 'Laboratorium', en: 'Science Bay' },
  'sav.shields':                { sv: 'Sköldar', en: 'Shields' },

  /* ---- Ship upgrades and crew gear any crew may buy. -------------------- */
  'sav.holo-emitters':          { sv: 'Holoemitterare', en: 'Holo-Emitters' },
  'sav.intruder-alarm':         { sv: 'Inbrottslarm', en: 'Intruder Alarm' },
  'sav.land-rover':             { sv: 'Terrängfordon', en: 'Land Rover' },
  'sav.power-reserves':         { sv: 'Kraftreserver', en: 'Power Reserves' },
  'sav.shuttle':                { sv: 'Skyttel', en: 'Shuttle' },
  'sav.stasis-pods':            { sv: 'Stasiskapslar', en: 'Stasis Pods' },
  'sav.vault':                  { sv: 'Kassavalv', en: 'Vault' },
  'sav.alien-pet':              { sv: 'Utomjordiskt husdjur', en: 'Alien Pet' },
  'sav.land-transport':         { sv: 'Marktransport', en: 'Land Transport' },
  'sav.recon-drone':            { sv: 'Spaningsdrönare', en: 'Recon Drone' },
  'sav.survival-gear':          { sv: 'Överlevnadsutrustning', en: 'Survival Gear' },
  'sav.workshop':               { sv: 'Verkstad', en: 'Workshop' },

  /* ---- Ship upgrades, per vessel. --------------------------------------- */
  /* Stardancer */
  'sav.false-ship-papers':      { sv: 'Falska skeppspapper', en: 'False Ship Papers' },
  'sav.dark-hyperspace-lane-maps': { sv: 'Kartor över mörka hyperrymdsleder', en: 'Dark Hyperspace Lane Maps' },
  'sav.smugglers-rigging':      { sv: 'Smugglarsele', en: 'Smuggler’s Rigging' },
  'sav.lucky-charm':            { sv: 'Lyckoamulett', en: 'Lucky Charm' },
  'sav.thrillseekers':          { sv: 'Spänningssökare', en: 'Thrillseekers' },
  /* Cerberus */
  'sav.tracers':                { sv: 'Spårsändare', en: 'Tracers' },
  'sav.stun-weapons':           { sv: 'Bedövningsvapen', en: 'Stun Weapons' },
  'sav.personal-vehicles':      { sv: 'Personliga farkoster', en: 'Personal Vehicles' },
  'sav.hard-knocks':            { sv: 'Hårda tag', en: 'Hard Knocks' },
  'sav.smooth-criminals':       { sv: 'Slipade brottslingar', en: 'Smooth Criminals' },
  /* Firedrake */
  'sav.black-market-contacts':  { sv: 'Svartabörskontakter', en: 'Black Market Contacts' },
  'sav.secret-base':            { sv: 'Hemlig bas', en: 'Secret Base' },
  'sav.popular-support':        { sv: 'Folkligt stöd', en: 'Popular Support' },
  'sav.way-blessed':            { sv: 'Vägvälsignad', en: 'Way Blessed' },
  'sav.driven':                 { sv: 'Driven', en: 'Driven' },

  /* ---- Ship special abilities, per vessel. ------------------------------ */
  /* Stardancer */
  'sav.the-getaway':            { sv: 'Undkomsten', en: 'The Getaway' },
  'sav.cargo-eye':              { sv: 'Lastöga', en: 'Cargo Eye' },
  'sav.field-repairs':          { sv: 'Fältreparationer', en: 'Field Repairs' },
  'sav.leverage':               { sv: 'Påtryckningsmedel', en: 'Leverage' },
  'sav.just-passing-through':   { sv: 'Bara på genomresa', en: 'Just Passing Through' },
  'sav.home-cooking':           { sv: 'Hemlagat', en: 'Home Cooking' },
  'sav.problem-solvers':        { sv: 'Problemlösare', en: 'Problem Solvers' },
  /* Cerberus */
  'sav.licensed':               { sv: 'Licensierade', en: 'Licensed' },
  'sav.on-the-trail':           { sv: 'På spåret', en: 'On the Trail' },
  'sav.light-touch':            { sv: 'Lätt hand', en: 'Light Touch' },
  'sav.snatch-n-grab':          { sv: 'Rycka och rusa', en: 'Snatch’n’Grab' },
  'sav.loaded-for-bear':        { sv: 'Rustade till tänderna', en: 'Loaded for Bear' },
  'sav.play-both-sides':        { sv: 'Spela på båda sidor', en: 'Play Both Sides' },
  'sav.deadly':                 { sv: 'Dödliga', en: 'Deadly' },
  /* Firedrake */
  'sav.old-hands':              { sv: 'Gamla rävar', en: 'Old Hands' },
  'sav.forged-in-fire':         { sv: 'Härdade i eld', en: 'Forged in Fire' },
  'sav.sympathizers':           { sv: 'Sympatisörer', en: 'Sympathizers' },
  'sav.natural-enemies':        { sv: 'Naturliga fiender', en: 'Natural Enemies' },
  'sav.spark-of-rebellion':     { sv: 'Upprorets gnista', en: 'Spark of Rebellion' },
  'sav.just-cause':             { sv: 'Rättfärdig sak', en: 'Just Cause' },
  'sav.hearts-and-minds':       { sv: 'Hjärtan och sinnen', en: 'Hearts & Minds' },

  /* ---- Common gear, the sheet's right-hand column. ---------------------- */
  'sav.blaster-pistol':         { sv: 'Blasterpistol', en: 'Blaster Pistol' },
  'sav.second-blaster-pistol':  { sv: 'Andra blasterpistolen', en: '2nd Blaster Pistol' },
  'sav.melee-weapon':           { sv: 'Närstridsvapen', en: 'Melee Weapon' },
  'sav.heavy-blaster':          { sv: 'Tung blaster', en: 'Heavy Blaster' },
  'sav.detonator':              { sv: 'Detonator', en: 'Detonator' },
  'sav.hacking-tools':          { sv: 'Hackverktyg', en: 'Hacking Tools' },
  'sav.repair-tools':           { sv: 'Reparationsverktyg', en: 'Repair Tools' },
  'sav.medkit':                 { sv: 'Sjukvårdsväska', en: 'Medkit' },
  'sav.spy-gear':               { sv: 'Spionutrustning', en: 'Spy Gear' },
  'sav.illicit-drugs':          { sv: 'Illegala droger', en: 'Illicit Drugs' },
  'sav.communicator':           { sv: 'Kommunikator', en: 'Communicator' },
  'sav.armor':                  { sv: 'Rustning', en: 'Armor' },
  'sav.spacesuit':              { sv: 'Rymddräkt', en: 'Spacesuit' },

  /* ---- Playbook gear. --------------------------------------------------- */
  /* Muscle — the signature weapons keep their names from the book. */
  'sav.krieger-blaster-pistol': { sv: 'Krieger, en fin blasterpistol', en: 'Krieger, a Fine Blaster Pistol' },
  'sav.vera-sniper-rifle':      { sv: 'Vera, ett fint prickskyttegevär', en: 'Vera, a Fine Sniper Rifle' },
  'sav.zmei-flamethrower':      { sv: 'Zmei, en fin eldkastare', en: 'Zmei, a Fine Flamethrower' },
  'sav.sunder-vibro-blade':     { sv: 'Sunder, en fin vibroklinga', en: 'Sunder, a Fine Vibro-Blade' },
  'sav.zarathustra-detonator-launcher': { sv: 'Zarathustra, detonatorkastare', en: 'Zarathustra, Detonator Launcher' },
  'sav.martial-arts-style':     { sv: 'Fin kampsportsstil', en: 'Fine Martial Art Style' },
  'sav.mystic-ammunition':      { sv: 'Mystisk ammunition', en: 'Mystic Ammunition' },
  /* Pilot */
  'sav.customized-spacesuit':   { sv: 'Fin skräddarsydd rymddräkt', en: 'Fine Customized Spacesuit' },
  'sav.small-urbot':            { sv: 'Fin liten urbot', en: 'Fine Small Urbot' },
  'sav.mechanics-kit':          { sv: 'Fin mekanikerlåda', en: 'Fine Mechanics Kit' },
  'sav.grappling-hook':         { sv: 'Änterhake', en: 'Grappling Hook' },
  'sav.guild-license':          { sv: 'Skrålicens', en: 'Guild License' },
  'sav.victory-cigars':         { sv: 'Segercigarrer', en: 'Victory Cigars' },
  /* Speaker */
  'sav.fine-clothes':           { sv: 'Fina kläder', en: 'Fine Clothes' },
  'sav.legitimate-id':          { sv: 'Äkta ID', en: 'Legitimate ID' },
  'sav.luxury-item':            { sv: 'Lyxföremål', en: 'Luxury Item' },
  'sav.large-luxury-item':      { sv: 'Stort lyxföremål', en: 'Large Luxury Item' },
  'sav.memento-past-encounter': { sv: 'Minne från ett möte', en: 'Memento of a Past Encounter' },
  /* Scoundrel */
  'sav.fine-blaster-pistol':    { sv: 'Fin blasterpistol (eller ett par)', en: 'Fine Blaster Pistol (or Pair)' },
  'sav.fine-coat':              { sv: 'Fin rock', en: 'Fine Coat' },
  'sav.loaded-dice':            { sv: 'Riggade tärningar eller holokort', en: 'Loaded Dice or Trick Holo-cards' },
  'sav.forged-documents':       { sv: 'Förfalskade dokument', en: 'Forged Documents' },
  'sav.personal-memento':       { sv: 'Personligt minne', en: 'Personal Memento' },
  /* Stitch */
  'sav.fine-medkit':            { sv: 'Fin sjukvårdsväska', en: 'Fine Medkit' },
  'sav.fine-bedside-manner':    { sv: 'Fint sängkantsmanér', en: 'Fine Bedside Manner' },
  'sav.fine-clothing':          { sv: 'Fina kläder', en: 'Fine Clothing' },
  'sav.recognizable-medic-garb': { sv: 'Igenkännlig läkardräkt', en: 'Recognizable Medic Garb' },
  'sav.candies-and-treats':     { sv: 'Godis och karameller', en: 'Candies and Treats' },
  'sav.syringes-and-applicators': { sv: 'Sprutor och applikatorer', en: 'Syringes and Applicators' },
  /* Mechanic */
  'sav.fine-hacking-rig':       { sv: 'Fin hackrigg', en: 'Fine Hacking Rig' },
  'sav.fine-ship-repair-tools': { sv: 'Fina skeppsreparationsverktyg', en: 'Fine Ship Repair Tools' },
  'sav.small-drone':            { sv: 'Liten drönare', en: 'Small Drone' },
  'sav.vision-enhancing-goggles': { sv: 'Synförstärkande glasögon', en: 'Vision-Enhancing Goggles' },
  'sav.spare-parts':            { sv: 'Reservdelar', en: 'Spare Parts' },
  'sav.genius-pet':             { sv: 'Genialiskt husdjur', en: 'Genius Pet' },
  /* Mystic */
  'sav.fine-melee-weapon':      { sv: 'Fint närstridsvapen', en: 'Fine Melee Weapon' },
  'sav.offerings':              { sv: 'Offergåvor', en: 'Offerings' },
  'sav.trappings-of-religion':  { sv: 'Religiösa attribut', en: 'Trappings of Religion' },
  'sav.outdated-religious-outfit': { sv: 'Omodern religiös dräkt', en: 'Outdated Religious Outfit' },
  'sav.memento-of-your-travels': { sv: 'Minne från dina resor', en: 'Memento of Your Travels' },
  'sav.precursor-artifact':     { sv: 'Föregångarartefakt', en: 'Precursor Artifact' },

  /* --------------- sharing ---------------------------------------------- */
  'share.button':    { sv: 'Import/Export', en: 'Import/Export' },
  'share.title':     { sv: 'Import/Export', en: 'Import/Export' },
  'share.cardTitle': { sv: 'Procyonsektorn',en: 'Procyon Sector' },
  'share.exportHint':{ sv: 'Välj vad som ska följa med. Den sparade bilden visas som ett kort i chatten och bär med sig all data.',
                       en: 'Pick what to send. The saved image previews as a card in chat and carries all the data with it.' },
  'share.receiveHint':{ sv: 'Importera en delad bild — dra hit den, eller:',
                        en: 'Import a shared image — drop it here, or:' },
  ...
  'share.importHint':{ sv: 'Inget skrivs över utan att du väljer det.',
                       en: 'Nothing is overwritten unless you choose it.' },
  'share.fromWho':   { sv: 'Delat av %s. Inget skrivs över utan att du väljer det.',
                       en: 'Shared by %s. Nothing is overwritten unless you choose it.' },
  'share.nothingToImport': { sv: 'Filen innehåller inget att importera.',
                             en: 'The file holds nothing to import.' },
  'share.status.new':      { sv: 'ny',        en: 'new' },
  'share.status.conflict': { sv: 'finns redan', en: 'already have' },
  'share.status.identical':{ sv: 'oförändrad', en: 'unchanged' },
  'share.keepBoth':  { sv: 'Behåll båda',   en: 'Keep both' },
  'share.replace':   { sv: 'Ersätt min',    en: 'Replace mine' },
  'share.doImport':  { sv: 'Importera',     en: 'Import' },
  'share.cancel':    { sv: 'Avbryt',        en: 'Cancel' },
  'share.importedTitle': { sv: 'Importerat', en: 'Imported' },
  'share.imported':  { sv: '%a tillagda, %b ersatta.', en: '%a added, %b replaced.' },
  'share.undo':      { sv: 'Ångra importen',en: 'Undo import' },
  'share.undone':    { sv: 'Importen är ångrad.', en: 'Import undone.' },
  'share.undoEdited':{ sv: 'Du har ändrat %s sedan importen. Ångra ändå?',
                       en: 'You have edited %s since importing. Undo anyway?' },
  'share.done':      { sv: 'Klart',         en: 'Done' },
  'share.andMore':   { sv: '+%n till',      en: '+%n more' },
  'share.errVersion':{ sv: 'Filen kommer från en annan version av appen.',
                       en: 'That file comes from a different version of this app.' },
  'share.errNoPayload': { sv: 'Bilden innehåller ingen delningsdata. Bilder som sparats om tappar den.',
                          en: 'That image carries no share data. Re-saved images lose it.' },
  ...
  'sheet.changePortrait': { sv: 'Klicka för att byta bild',
                            en: 'Click to change picture' },
  'sheet.uploadOwn': { sv: 'Ladda upp egen', en: 'Upload your own' },
  'sheet.removeOwn': { sv: 'Ta bort egen',   en: 'Remove yours' },
  'sheet.close':     { sv: 'Stäng',          en: 'Close' },
  'sheet.startingAction': { sv: 'Arketypens startprick: %s',
                            en: 'Playbook starting dot: %s' },
  'sheet.startingAbility': { sv: 'Startförmåga', en: 'Starting ability' },
  ...
  'sheet.save':      { sv: 'Spara',        en: 'Save' },
  'sheet.unsaved':   { sv: 'Du har osparade ändringar. Kasta dem?',
                       en: 'You have unsaved changes. Discard them?' },
  'sheet.fieldLabel':{ sv: 'Etikett',      en: 'Label' },

  /* Ship sheet */
  'sheet.frame':     { sv: 'Skrov',        en: 'Frame' },
  'sheet.spriteOverride': { sv: 'Egen bild', en: 'Custom art' },
  'sheet.spriteNone':{ sv: 'ingen',         en: 'none' },
  ...
  'sheet.auxiliary': { sv: 'Hjälpmoduler', en: 'Auxiliary modules' },
  'sheet.shipUpgrades': { sv: 'Skeppsuppgraderingar', en: 'Ship upgrades' },
  'sheet.shipAbilities': { sv: 'Särskilda förmågor', en: 'Special abilities' },
  'sheet.gear':      { sv: 'Utrustning', en: 'Gear' },
  'sheet.size':      { sv: 'Storlek', en: 'Size' },
  'sheet.gambits':   { sv: 'Gambits per uppdrag', en: 'Gambits per job' },
  ...
  'action.doctor':   { sv: 'Vårda',        en: 'Doctor' },
  'action.hack':     { sv: 'Hacka',        en: 'Hack' },
  'action.rig':      { sv: 'Fixa',         en: 'Rig' },
  'action.study':    { sv: 'Studera',      en: 'Study' },
  'action.helm':     { sv: 'Styra',        en: 'Helm' },
  'action.scramble': { sv: 'Rusa',         en: 'Scramble' },
  ...
  'sav.freighter':              { sv: 'Fraktskepp (medium, kan landa)', en: 'Freighter (Medium, can land on planets)' },
  'sav.corvette':               { sv: 'Korvett (stor, kan inte landa)', en: 'Corvette (Large, can’t land on planets)' },
  'ship.crew':       { sv: 'Besättning',   en: 'Crew quality' },
  ...
  'rel.friend':  { sv: 'Vän',     en: 'Friend' },
  'rel.neutral': { sv: 'Neutral', en: 'Neutral' },
  'rel.rival':   { sv: 'Rival',   en: 'Rival' },
  'faction.status': { sv: 'Status', en: 'Status' },
  'ship.statusSection': { sv: 'Status hos fraktioner',
                          en: 'Faction status' },
  'ship.addStatus': { sv: 'Lägg till fraktion…', en: 'Track a faction…' },
  'faction.noShip': { sv: 'Skapa ett skepp för att spåra status.',
                      en: 'Create a ship to track status.' },
  'sheet.createContact': { sv: 'Skapa ny', en: 'Create new' },
  'sheet.searchContact': { sv: 'Sök eller skapa kontakt…',
                           en: 'Search or create a contact…' },
  ...
  'faction.nightspeakers.name': { sv: 'Nattmälarna', en: 'Nightspeakers' },
