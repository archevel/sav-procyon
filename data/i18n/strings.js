...
export const STRINGS = {
  ...
  'sheet.disposition': { sv: 'Inställning',  en: 'Disposition' },
  'faction.disposition': { sv: 'Inställning till besättningen',
                           en: 'Disposition toward the crew' },
  'disp.m3': { sv: '−3 Krig',        en: '−3 War' },
  'disp.m2': { sv: '−2 Fientlig',    en: '−2 Hostile' },
  'disp.m1': { sv: '−1 Motarbetar',  en: '−1 Interfering' },
  'disp.z':  { sv: '±0 Neutral',     en: '±0 Neutral' },
  'disp.p1': { sv: '+1 Hjälpsam',    en: '+1 Helpful' },
  'disp.p2': { sv: '+2 Vänskaplig',  en: '+2 Friendly' },
  'disp.p3': { sv: '+3 Allierad',    en: '+3 Allied' },
