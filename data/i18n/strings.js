...
export const STRINGS = {
  ...
  'sav.ancient-interface':            { sv: 'Uråldrigt gränssnitt', en: 'Ancient Interface' },
  'sav.armor':                        { sv: 'Rustning', en: 'Armor' },
  'sav.armor-plating':                { sv: 'Pansarplåt', en: 'Armor Plating' },
  'sav.artificer':                    { sv: 'Konstruktör', en: 'Artificer' },
  'sav.bantam':                       { sv: 'Nätt', en: 'Bantam' },
  'sav.battle-hardened':              { sv: 'Stridshärdad', en: 'Battle-Hardened' },
  'sav.battlefield-medic':            { sv: 'Fältläkare', en: 'Battlefield Medic' },
  'sav.bedside-manner':               { sv: 'Vårdande hand', en: 'Bedside Manner' },
  'sav.bio-scanner':                  { sv: 'Bioskanner', en: 'Bio-Scanner' },
  'sav.blade':                        { sv: 'Klinga', en: 'Blade' },
  'sav.blade-or-baton':               { sv: 'Klinga eller batong', en: 'Blade or Baton' },
  'sav.blaster':                      { sv: 'Blaster', en: 'Blaster' },
  'sav.bodyguard':                    { sv: 'Livvakt', en: 'Bodyguard' },
  'sav.boost-thrusters':              { sv: 'Boostmotorer', en: 'Boost Thrusters' },
  'sav.born-to-the-black':            { sv: 'Född till tomrummet', en: 'Born to the Black' },
  'sav.breaching-charge':             { sv: 'Sprängladdning', en: 'Breaching Charge' },
  'sav.brig':                         { sv: 'Arrest', en: 'Brig' },
  'sav.bulk-fuel':                    { sv: 'Extra bränsle', en: 'Bulk Fuel' },
  'sav.cargo-hold':                   { sv: 'Lastrum', en: 'Cargo Hold' },
  'sav.cerberus':                     { sv: 'Cerberus', en: 'Cerberus' },
  'sav.chemist':                      { sv: 'Kemist', en: 'Chemist' },
  'sav.climbing-gear':                { sv: 'Klätterutrustning', en: 'Climbing Gear' },
  'sav.cloak-and-dagger':             { sv: 'Kappa och dolk', en: 'Cloak and Dagger' },
  'sav.cold':                         { sv: 'Kall', en: 'Cold' },
  'sav.colonist':                     { sv: 'Kolonist', en: 'Colonist' },
  'sav.comms-unit':                   { sv: 'Kommunikatör', en: 'Comms Unit' },
  'sav.compel':                       { sv: 'Tvinga', en: 'Compel' },
  'sav.coreworlder':                  { sv: 'Kärnvärldsbo', en: 'Coreworlder' },
  'sav.credit-chits':                 { sv: 'Kreditbrickor', en: 'Credit Chits' },
  'sav.diagnostic-scanner':           { sv: 'Diagnosskanner', en: 'Diagnostic Scanner' },
  'sav.disguise-kit':                 { sv: 'Förklädnad', en: 'Disguise Kit' },
  'sav.docking-clamps':               { sv: 'Dockningsklor', en: 'Docking Clamps' },
  'sav.documents':                    { sv: 'Dokument', en: 'Documents' },
  'sav.drugs':                        { sv: 'Droger', en: 'Drugs' },
  'sav.encrypted-comms':              { sv: 'Krypterad kommunikation', en: 'Encrypted Comms' },
  'sav.faith':                        { sv: 'Tro', en: 'Faith' },
  'sav.fine-clothes':                 { sv: 'Fina kläder', en: 'Fine Clothes' },
  'sav.firedrake':                    { sv: 'Firedrake', en: 'Firedrake' },
  'sav.flight-suit':                  { sv: 'Flygdräkt', en: 'Flight Suit' },
  'sav.fly-casual':                   { sv: 'Flyg avslappnat', en: 'Fly Casual' },
  'sav.functional':                   { sv: 'Funktionell', en: 'Functional' },
  'sav.galley':                       { sv: 'Kabyss', en: 'Galley' },
  'sav.gambling':                     { sv: 'Spel', en: 'Gambling' },
  'sav.ghost-echo':                   { sv: 'Spökeko', en: 'Ghost Echo' },
  'sav.ghost-fighter':                { sv: 'Spökkämpe', en: 'Ghost Fighter' },
  'sav.ghost-voice':                  { sv: 'Spökröst', en: 'Ghost Voice' },
  'sav.ghost-ward':                   { sv: 'Spökvärn', en: 'Ghost Ward' },
  'sav.gift':                         { sv: 'Gåva', en: 'Gift' },
  'sav.grease-monkey':                { sv: 'Skruvapa', en: 'Grease Monkey' },
  'sav.hard-burn':                    { sv: 'Full gas', en: 'Hard Burn' },
  'sav.haunted':                      { sv: 'Hemsökt', en: 'Haunted' },
  'sav.heavy-armor':                  { sv: 'Tung rustning', en: 'Heavy Armor' },
  'sav.heavy-cannon':                 { sv: 'Tung kanon', en: 'Heavy Cannon' },
  'sav.heavy-pistol':                 { sv: 'Tung pistol', en: 'Heavy Pistol' },
  'sav.heavy-tools':                  { sv: 'Tunga verktyg', en: 'Heavy Tools' },
  'sav.hidden-hold':                  { sv: 'Dolt lastrum', en: 'Hidden Hold' },
  'sav.infiltrator':                  { sv: 'Infiltratör', en: 'Infiltrator' },
  'sav.jaded':                        { sv: 'Avtrubbad', en: 'Jaded' },
  'sav.jamming-suite':                { sv: 'Störsändare', en: 'Jamming Suite' },
  'sav.labor':                        { sv: 'Arbetare', en: 'Labor' },
  'sav.like-part-of-the-family':      { sv: 'Som en i familjen', en: 'Like Part of the Family' },
  'sav.lockpicks':                    { sv: 'Dyrkar', en: 'Lockpicks' },
  ...
  'sav.mesmerism':                    { sv: 'Hypnos', en: 'Mesmerism' },
  ...
  'sav.quarters':                     { sv: 'Hytter', en: 'Quarters' },
  'sav.rations':                      { sv: 'Ranson', en: 'Rations' },
  'sav.rebreather':                   { sv: 'Andningsmask', en: 'Rebreather' },
  'sav.reckless':                     { sv: 'Vårdslös', en: 'Reckless' },
  'sav.recorder':                     { sv: 'Inspelare', en: 'Recorder' },
  'sav.reflexes':                     { sv: 'Reflexer', en: 'Reflexes' },
  'sav.reinforced-hull':              { sv: 'Förstärkt skrov', en: 'Reinforced Hull' },
  'sav.repair-drone':                 { sv: 'Reparationsdrönare', en: 'Repair Drone' },
  'sav.rim-dweller':                  { sv: 'Utkantsbo', en: 'Rim Dweller' },
  'sav.ritual':                       { sv: 'Ritual', en: 'Ritual' },
  'sav.rope':                         { sv: 'Rep', en: 'Rope' },
  'sav.savage':                       { sv: 'Vild', en: 'Savage' },
  'sav.scanner':                      { sv: 'Skanner', en: 'Scanner' },
  'sav.scary-weapon':                 { sv: 'Skrämmande vapen', en: 'Scary Weapon' },
  'sav.scoundrel':                    { sv: 'Skurk', en: 'Scoundrel' },
  'sav.scout':                        { sv: 'Spanare', en: 'Scout' },
  'sav.sedatives':                    { sv: 'Lugnande', en: 'Sedatives' },
  'sav.sensor-array':                 { sv: 'Sensorrad', en: 'Sensor Array' },
  'sav.shadow':                       { sv: 'Skugga', en: 'Shadow' },
  'sav.silenced-pistol':              { sv: 'Ljuddämpad pistol', en: 'Silenced Pistol' },
  'sav.silent-running':               { sv: 'Tyst gång', en: 'Silent Running' },
  'sav.sixth-sense':                  { sv: 'Sjätte sinne', en: 'Sixth Sense' },
  'sav.slippery':                     { sv: 'Hal', en: 'Slippery' },
  ...
  'sav.subterfuge':                   { sv: 'List', en: 'Subterfuge' },
  'sav.superior-engines':             { sv: 'Överlägsna motorer', en: 'Superior Engines' },
  'sav.surgeon':                      { sv: 'Kirurg', en: 'Surgeon' },
  'sav.surgical-kit':                 { sv: 'Kirurgset', en: 'Surgical Kit' },
  'sav.synthetic':                    { sv: 'Syntet', en: 'Synthetic' },
  'sav.tempest':                      { sv: 'Storm', en: 'Tempest' },
  'sav.the-way':                      { sv: 'Vägen', en: 'The Way' },
  'sav.thief':                        { sv: 'Tjuv', en: 'Thief' },
  'sav.throwing-blades':              { sv: 'Kastknivar', en: 'Throwing Blades' },
  'sav.tinkerer':                     { sv: 'Pillare', en: 'Tinkerer' },
  'sav.toolkit':                      { sv: 'Verktygsväska', en: 'Toolkit' },
  'sav.tools':                        { sv: 'Verktyg', en: 'Tools' },
  'sav.trade':                        { sv: 'Handel', en: 'Trade' },
  'sav.trust-me':                     { sv: 'Lita på mig', en: 'Trust Me' },
  'sav.turret':                       { sv: 'Torn', en: 'Turret' },
  'sav.underworld':                   { sv: 'Undre världen', en: 'Underworld' },
  'sav.unstable':                     { sv: 'Instabil', en: 'Unstable' },
  'sav.vicious':                      { sv: 'Grym', en: 'Vicious' },
  'sav.vigorous':                     { sv: 'Livskraftig', en: 'Vigorous' },
  ...
  'sav.weird-contacts':               { sv: 'Underliga kontakter', en: 'Weird Contacts' },
  'sav.welding-gear':                 { sv: 'Svetsutrustning', en: 'Welding Gear' },
  'sav.well-connected':               { sv: 'Välkontaktad', en: 'Well Connected' },
  'sav.wingman':                      { sv: 'Vingman', en: 'Wingman' },
