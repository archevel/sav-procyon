...
export const STRINGS = {
  ...
  'sheet.playbook':  { sv: 'Arketyp',      en: 'Playbook' },
  'sheet.alias':     { sv: 'Alias',        en: 'Alias' },
  'sheet.heritage':  { sv: 'Ursprung',     en: 'Heritage' },
  ...
  'sheet.xp':        { sv: 'XP',           en: 'XP' },
  'sheet.playbookXp':{ sv: 'Arketyp-XP',   en: 'Playbook XP' },
  'sheet.condition': { sv: 'Tillstånd',    en: 'Condition' },
  'sheet.stress':    { sv: 'Stress',       en: 'Stress' },
  'sheet.healing':   { sv: 'Läkning',      en: 'Healing' },
  'sheet.harm1':     { sv: 'Lindrig',      en: 'Lesser' },
  'sheet.harm2':     { sv: 'Måttlig',      en: 'Moderate' },
  'sheet.harm3':     { sv: 'Svår',         en: 'Severe' },
  'sheet.kit':       { sv: 'Utrustning',   en: 'Kit' },
  'sheet.load':      { sv: 'Last',         en: 'Load' },
  'sheet.items':     { sv: 'Föremål',      en: 'Items' },
  'sheet.abilities': { sv: 'Förmågor',     en: 'Special abilities' },
  'sheet.picksNote': { sv: 'Regeltexten står i boken — anteckna egna sammanfattningar nedan.',
                       en: 'Rules text lives in the book — add your own summaries in Notes.' },
  'sheet.clocks':    { sv: 'Klockor',      en: 'Clocks' },
  'sheet.addClock':  { sv: 'Ny klocka',    en: 'Add clock' },
  'sheet.clockName': { sv: 'Vad räknas ner?', en: 'What is counting down?' },
  'sheet.notes':     { sv: 'Anteckningar', en: 'Notes' },
  'sheet.addNote':   { sv: 'Ny anteckning',en: 'Add note' },
  'sheet.noteTitle': { sv: 'Rubrik',       en: 'Title' },
  'sheet.noteBody':  { sv: 'Text…',        en: 'Text…' },
  'sheet.addImage':  { sv: 'Lägg till bild', en: 'Add image' },
  'sheet.remove':    { sv: 'Ta bort',      en: 'Remove' },
  'sheet.extra':     { sv: 'Egna fält',    en: 'Custom fields' },
  'sheet.addField':  { sv: 'Nytt fält',    en: 'Add field' },
  'sheet.fieldLabel':{ sv: 'Etikett',      en: 'Label' },

  /* Ship sheet */
  'sheet.frame':     { sv: 'Skrov',        en: 'Frame' },
  'sheet.systems':   { sv: 'System',       en: 'Systems' },
  'sheet.damaged':   { sv: 'Skadat',       en: 'Damaged' },
  'sheet.gambit':    { sv: 'Gambit',       en: 'Gambit' },
  'sheet.upgrades':  { sv: 'Uppgraderingar', en: 'Upgrades' },
  'sheet.crewUpgrades': { sv: 'Besättningsutrymmen', en: 'Crew upgrades' },
  'sheet.slotsUsed': { sv: '%a av %b platser använda', en: '%a of %b slots used' },
  ...
  'attr.prowess':    { sv: 'Bravur',       en: 'Prowess' },
  'attr.resolve':    { sv: 'Beslutsamhet', en: 'Resolve' },
  'action.doctor':   { sv: 'Doktorera',    en: 'Doctor' },
  'action.hack':     { sv: 'Hacka',        en: 'Hack' },
  'action.rig':      { sv: 'Rigga',        en: 'Rig' },
  'action.study':    { sv: 'Studera',      en: 'Study' },
  'action.helm':     { sv: 'Styra',        en: 'Helm' },
  'action.scramble': { sv: 'Kämpa',        en: 'Scramble' },
  'action.scrap':    { sv: 'Slåss',        en: 'Scrap' },
  'action.skulk':    { sv: 'Smyga',        en: 'Skulk' },
  'action.attune':   { sv: 'Samklinga',    en: 'Attune' },
  'action.command':  { sv: 'Befalla',      en: 'Command' },
  'action.consort':  { sv: 'Umgås',        en: 'Consort' },
  'action.sway':     { sv: 'Övertala',     en: 'Sway' },
  'load.light':      { sv: 'Lätt',         en: 'Light' },
  'load.normal':     { sv: 'Normal',       en: 'Normal' },
  'load.heavy':      { sv: 'Tung',         en: 'Heavy' },
  'ship.engines':    { sv: 'Motorer',      en: 'Engines' },
  'ship.hull':       { sv: 'Skrov',        en: 'Hull' },
  'ship.comms':      { sv: 'Kommunikation',en: 'Comms' },
  'ship.weapons':    { sv: 'Vapen',        en: 'Weapons' },
  'ship.craft':      { sv: 'Farkoster',    en: 'Craft' },
