...
export const STRINGS = {
  ...
  'share.exportHint':{ sv: 'Välj vad som ska följa med. Bilden visas som ett kort i chatten och kan dras hit för att importeras.',
                       en: 'Pick what to send. The image previews as a card in chat, and can be dragged back here to import.' },
  ...
  'share.tooLongForLink': { sv: 'För mycket data för en länk — ladda ner bilden i stället.',
                            en: 'Too much data for a link — download the image instead.' },
  'share.imagesNote':{ sv: '%n bild(er) följer med i den nedladdade bilden, men inte i en länk.',
                       en: '%n image(s) travel in the downloaded image, but not in a link.' },
